...
export class CommonConstants {
     ...
     * Title text.
     */
    static readonly SPLASH_DES: string = 'XZIT Talaba Qo\'llanmasi';
    static readonly SPLASH_WELCOME: string = 'Xuzhou Institute of Technology';
    static readonly INTRODUCTION_TITLE: string = 'Binolar';
    static readonly TRAIN_TITLE: string = "Dars Jadvali";
    /**
     * Default content in the search box.
     */
    static readonly PANEL_PLACEHOLDER: string = 'Bino qidirish...';
    /**
     * Number of columns.
     */
    ...
    /**
     * Bottom Latitude — XZIT Xincheng campus south bound.
     */
    static readonly SOUTH_LATITUDE: number = 34.228;
    /**
     * Top Latitude — XZIT Xincheng campus north bound.
     */
    static readonly NORTH_LATITUDE: number = 34.240;
    /**
     * Left Longitude — XZIT Xincheng campus west bound.
     */
    static readonly WEST_LONGITUDE: number = 117.349;
    /**
     * Right Longitude — XZIT Xincheng campus east bound.
     */
    static readonly EAST_LONGITUDE: number = 117.362;
    /**
    ...
    /**
     * Number of landmarks on the XZIT campus map.
     */
    static MAP_LANDMARKS_LENGTH: number = 8;
    /**
     * Map Zoom Ratio.
     */
